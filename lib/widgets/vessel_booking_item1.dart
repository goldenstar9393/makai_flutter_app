          ...
          return !snapshot.hasData
              ...
              : ExpansionTile(
                  ...
                  title: Column(
                    ...
                    children: [
                      Text(Vessel.fromDocument(snapshot.data as DocumentSnapshot<Map<String, dynamic>>).vesselName!, style: TextStyle(fontWeight: FontWeight.bold)),
                      Text(DateFormat('MMMM dd, yyyy').format(booking.travelDate!.toDate()), style: TextStyle(color: primaryColor)),
                    ],
                  ),
                  subtitle: Padding(
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.group_outlined, color: Colors.green, size: 15),
                              Text('${booking.guestCount}', textScaleFactor: 0.85, style: TextStyle(color: Colors.green)),
                            ],
                          ),
                        ),
                        Container(
                          ...
                          padding: const EdgeInsets.all(3),
                          decoration: BoxDecoration(border: Border.all(color: getColor(booking.status!))),
                          child: Text(getStatus(booking.status!), textScaleFactor: 0.85, style: TextStyle(fontWeight: FontWeight.bold, color: getColor(booking.status!))),
                        ),
                        Container(
                          padding: const EdgeInsets.all(3),
                          decoration: BoxDecoration(border: Border.all(color: booking.paid! ? Colors.green : Colors.red)),
                          child: Text(booking.paid! ? 'Paid' : 'Not Paid', textScaleFactor: 0.85, style: TextStyle(fontWeight: FontWeight.bold, color: booking.paid! ? Colors.green : Colors.red)),
                        ),
                      ],
                    ),
                  ),
